...
const services = [
  ...
  },
  {
    ...
    description: "Expert guidance to help your organization or project succeed",
    details: [
    ...
    whoItsFor:
      "Nonprofits, community organizations, small businesses, and local governments seeking expert guidance",
    customLink: "/services/technical-assistance",
  },
  {
    slug: "feasibility",
                    ...
                    <div>
                      ...
                      <Button asChild>
                        <Link
                          href={
                            service.customLink ||
                            `/get-support?service=${service.slug}`
                          }
                        >
